...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:4200","https://http://localhost:8080")); // Consenti tutte le origini, è possibile specificare origini specifiche se necessario
